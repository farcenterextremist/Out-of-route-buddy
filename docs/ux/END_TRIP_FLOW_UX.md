...
**Related:** 25-point list #5, `docs/archive/APP_IMPROVEMENT_25_POINT_BRAINSTORM.md`, `docs/product/FEATURE_BRIEF_monthly_stats_and_persistence.md`, `docs/technical/TRIP_PERSISTENCE_END_CLEAR.md`.
