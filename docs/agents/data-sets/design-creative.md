...
- **Prioritization notes:** Short notes the coordinator can use (e.g. “Next 3: Auto drive, Reports screen, History improvements”) in `docs/product/` or in the roadmap.

### Secondary
- **Decision summaries:** When the user must make a product decision, write a one-paragraph summary or clear options (e.g. “Option A vs B vs defer”).
...
- “The user asked for [X]; how does it fit the product?” — Design frames the answer for direct review.
