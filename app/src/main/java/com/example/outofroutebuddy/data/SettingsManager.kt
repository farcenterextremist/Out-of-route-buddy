...
class SettingsManager @Inject constructor(
    ...
    fun setGpsUpdateFrequency(seconds: Int) = prefs.edit().putInt("gps_update_frequency", seconds).apply()
    
    fun isHighAccuracyMode(): Boolean = prefs.getBoolean("high_accuracy_mode", true)
    fun setHighAccuracyMode(enabled: Boolean) = prefs.edit().putBoolean("high_accuracy_mode", enabled).apply()
    
    // Display Settings
    fun getDistanceUnits(): String = prefs.getString("distance_units", "miles") ?: "miles"
    fun setDistanceUnits(units: String) = prefs.edit().putString("distance_units", units).apply()
    ...
    fun setThemePreference(theme: String) = prefs.edit().putString("theme_preference", theme).apply()
    ...
    fun setNotificationSoundEnabled(enabled: Boolean) = prefs.edit().putBoolean("notification_sound", enabled).apply()
    
    // Trip Settings
    fun isAutoStartTripEnabled(): Boolean = prefs.getBoolean("auto_start_trip", false)
    fun setAutoStartTripEnabled(enabled: Boolean) = prefs.edit().putBoolean("auto_start_trip", enabled).apply()
    
    fun isAutoSaveTripEnabled(): Boolean = prefs.getBoolean("auto_save_trip", true)
    fun setAutoSaveTripEnabled(enabled: Boolean) = prefs.edit().putBoolean("auto_save_trip", enabled).apply()
    
    // Advanced Settings
    fun isBatteryOptimizationEnabled(): Boolean = prefs.getBoolean("battery_optimization", true)
    fun setBatteryOptimizationEnabled(enabled: Boolean) = prefs.edit().putBoolean("battery_optimization", enabled).apply()
